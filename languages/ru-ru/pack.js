  ...
  "entries": [
    ...
    },
    {
      ...
      "example": {
        ...
        "zh": "演唱会吸引了一万名观众。",
        "text": "Концерт собрал десять тысяч человек.",
        "pronunciation": "Kontsyert sobral dyesyat tysyach chyelovyek."
      },
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "请帮我确认一下登机口。",
      "text": "Можете ли вы подтвердить выход на посадку?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Mozhyetye li vy podtvyerdit vykhod na posadku?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "什么时候开始登机？",
      "text": "Когда начинается посадка?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Kogda nachinayetsya posadka?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "起飞时间推迟了吗？",
      "text": "Время вылета было задержано?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Vryemya vylyeta bylo zadyerzhano?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "我的安全带扣不上。",
      "text": "Я не могу пристегнуть ремень безопасности.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Ya nye mogu pristyegnut ryemyen byezopasnosti.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "持中国护照应该走哪条入境通道？",
      "text": "Какую иммиграционную линию мне следует использовать с китайским паспортом?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Kakuyu immigratsionnuyu liniyu mnye slyeduyet ispolzovat s kitayskim pasportom?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "还需要填写入境卡吗？",
      "text": "Нужно ли мне еще заполнять входную карту?",
      "direction": "traveler-says",
      "intent": "confirm",
      "pronunciation": "Nuzhno li mnye yeshchye zapolnyat vkhodnuyu kartu?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以帮我填写海关申报单吗？",
      "text": "Можете ли вы помочь мне заполнить таможенную декларацию?",
      "direction": "traveler-says",
      "intent": "repair",
      "pronunciation": "Mozhyetye li vy pomoch mnye zapolnit tamozhyennuyu dyeklaratsiyu?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "非美国护照应该排哪一队？",
      "text": "Какая линия предназначена для неамериканских паспортов?",
      "direction": "traveler-says",
      "intent": "ask",
      "pronunciation": "Kakaya liniya pryednaznachyena dlya nyeamyerikanskikh pasportov?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "请打表。",
      "text": "Включите счетчик, пожалуйста.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Vklyuchitye schyetchik, pozhaluysta.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "请开到这个地址。",
      "text": "Отвезите меня по этому адресу, пожалуйста.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Otvyezitye myenya po etomu adryesu, pozhaluysta.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "到机场大约多少钱？",
      "text": "Сколько примерно стоит до аэропорта?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Skolko primyerno stoit do aeroporta?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "最近的加油站在哪里？",
      "text": "Где находится ближайшая заправка?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Gdye nakhoditsya blizhayshaya zapravka?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "这辆车用汽油还是柴油？",
      "text": "Эта машина использует бензин или дизельное топливо?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Eta mashina ispolzuyet byenzin ili dizyelnoye toplivo?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "请加满普通无铅汽油。",
      "text": "Залейте его обычным неэтилированным бензином, пожалуйста.",
      "direction": "traveler-says",
      "intent": "confirm",
      "pronunciation": "Zalyeytye yego obychnym nyeetilirovannym byenzinom, pozhaluysta.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "停车费在哪里支付？",
      "text": "Где я могу заплатить за парковку?",
      "direction": "traveler-says",
      "intent": "repair",
      "pronunciation": "Gdye ya mogu zaplatit za parkovku?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "过了红绿灯就是入口。",
      "text": "Вход сразу после светофора.",
      "direction": "traveler-says",
      "intent": "ask",
      "pronunciation": "Vkhod srazu poslye svyetofora.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "房间里有熨斗吗？",
      "text": "В комнате есть утюг?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "V komnatye yest utyug?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以在房间里加一张婴儿床吗？",
      "text": "Вы можете поставить детскую кроватку в комнату?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Vy mozhyetye postavit dyetskuyu krovatku v komnatu?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "今晚所有房型都满了吗？",
      "text": "Все типы номеров полностью забронированы на сегодня?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Vsye tipy nomyerov polnostyu zabronirovany na syegodnya?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "这一层的灭火器在哪里？",
      "text": "Где огнетушитель на этом этаже?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Gdye ognyetushityel na etom etazhye?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "周末也已经满房了吗？",
      "text": "У вас тоже все забронировано на эти выходные?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "U vas tozhye vsye zabronirovano na eti vykhodnyye?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "退房后可以寄存行李吗？",
      "text": "Можно оставить багаж после выезда?",
      "direction": "traveler-says",
      "intent": "confirm",
      "pronunciation": "Mozhno ostavit bagazh poslye vyyezda?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以给我一张正式收据吗？",
      "text": "Можете ли вы дать мне официальную квитанцию?",
      "direction": "traveler-says",
      "intent": "repair",
      "pronunciation": "Mozhyetye li vy dat mnye ofitsialnuyu kvitantsiyu?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "请帮我核对一下账单。",
      "text": "Не могли бы вы обсудить со мной счет?",
      "direction": "traveler-says",
      "intent": "ask",
      "pronunciation": "Nye mogli by vy obsudit so mnoy schyet?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以给我一双筷子吗？",
      "text": "Можешь принести мне палочки для еды?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Mozhyesh prinyesti mnye palochki dlya yedy?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "汤匙掉到地上了，可以换一把吗？",
      "text": "Я уронил ложку, можешь принести мне еще?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Ya uronil lozhku, mozhyesh prinyesti mnye yeshchye?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以再给我一把叉子吗？",
      "text": "Можешь принести мне еще одну вилку?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Mozhyesh prinyesti mnye yeshchye odnu vilku?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "请把酱汁放在旁边。",
      "text": "Могу ли я снять повязку сбоку?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Mogu li ya snyat povyazku sboku?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "牛肉请做全熟。",
      "text": "Хорошо прожаренную говядину, пожалуйста.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Khorosho prozharyennuyu govyadinu, pozhaluysta.",
    ...
    },
    {
      ...
      "direction": "traveler-says",
      "intent": "repair",
      "pronunciation": "Schyet, pozhaluysta.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以在收银台分开付款吗？",
      "text": "Можем ли мы заплатить отдельно в кассе?",
      "direction": "traveler-says",
      "intent": "ask",
      "pronunciation": "Mozhyem li my zaplatit otdyelno v kassye?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "有没有更便宜的款式？",
      "text": "У вас есть более дешевая модель?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "U vas yest bolyeye dyeshyevaya modyel?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "标价包含增值税吗？",
      "text": "НДС включён в цену?",
      "direction": "traveler-hears",
      "intent": "local-use",
      "pronunciation": "NDS vklyuchyon v tsyenu?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以用信用卡付款吗？",
      "text": "Могу ли я оплатить кредитной картой?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Mogu li ya oplatit kryeditnoy kartoy?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以用现金付款吗？",
      "text": "Можно оплатить наличными?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Mozhno oplatit nalichnymi?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "小票上的价格不对。",
      "text": "Цена в чеке указана неверно.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Tsyena v chyekye ukazana nyevyerno.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以重新打印小票吗？",
      "text": "Не могли бы вы перепечатать квитанцию?",
      "direction": "traveler-says",
      "intent": "confirm",
      "pronunciation": "Nye mogli by vy pyeryepyechatat kvitantsiyu?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "小票上没有显示折扣。",
      "text": "Скидка не указана в чеке.",
      "direction": "traveler-says",
      "intent": "repair",
      "pronunciation": "Skidka nye ukazana v chyekye.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以给我一张礼品小票吗？",
      "text": "Могу ли я получить подарочный чек?",
      "direction": "traveler-says",
      "intent": "ask",
      "pronunciation": "Mogu li ya poluchit podarochnyy chyek?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "过桥后向左转。",
      "text": "Перейдя мост, поверните налево.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Pyeryeydya most, povyernitye nalyevo.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "这条路通往市中心吗？",
      "text": "Эта дорога ведет в центр города?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Eta doroga vyedyet v tsyentr goroda?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "这条街叫什么名字？",
      "text": "Как называется эта улица?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Kak nazyvayetsya eta ulitsa?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "最近的银行几点关门？",
      "text": "Во сколько закрывается ближайший банк?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Vo skolko zakryvayetsya blizhayshiy bank?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "哪一站是公交车站？",
      "text": "Какую остановку мне следует использовать для автобуса?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Kakuyu ostanovku mnye slyeduyet ispolzovat dlya avtobusa?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以推荐一个附近的景点吗？",
      "text": "Можете ли вы порекомендовать близлежащую достопримечательность?",
      "direction": "traveler-says",
      "intent": "confirm",
      "pronunciation": "Mozhyetye li vy poryekomyendovat blizlyezhashchuyu dostoprimyechatyelnost?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "今天博物馆开门吗？",
      "text": "Музей открыт сегодня?",
      "direction": "traveler-says",
      "intent": "repair",
      "pronunciation": "Muzyey otkryt syegodnya?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "从这里怎么去公园？",
      "text": "Как отсюда добраться до парка?",
      "direction": "traveler-says",
      "intent": "ask",
      "pronunciation": "Kak otsyuda dobratsya do parka?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "伤口需要缝针吗？",
      "text": "Нужно ли накладывать швы на эту рану?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Nuzhno li nakladyvat shvy na etu ranu?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "我受伤了，请叫救护车。",
      "text": "Я ранен. Пожалуйста, вызовите скорую.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Ya ranyen. Pozhaluysta, vyzovitye skoruyu.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "我可能骨折了。",
      "text": "Я думаю, что у меня перелом.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Ya dumayu, chto u myenya pyeryelom.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "请拨打911叫救护车。",
      "text": "Пожалуйста, позвоните по номеру 911, чтобы вызвать скорую помощь.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Pozhaluysta, pozvonitye po nomyeru 911, chtoby vyzvat skoruyu pomoshch.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "怎样才能止血？",
      "text": "Как остановить кровотечение?",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Kak ostanovit krovotyechyeniye?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "这是我的保险卡。",
      "text": "Это моя страховая карта.",
      "direction": "traveler-says",
      "intent": "confirm",
      "pronunciation": "Eto moya strakhovaya karta.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "保险公司需要一份医疗报告。",
      "text": "Страховщику необходимо медицинское заключение.",
      "direction": "traveler-says",
      "intent": "repair",
      "pronunciation": "Strakhovshchiku nyeobkhodimo myeditsinskoye zaklyuchyeniye.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "可以在报告中写上我的保险号码吗？",
      "text": "Можете ли вы указать номер моей страховки в отчете?",
      "direction": "traveler-says",
      "intent": "ask",
      "pronunciation": "Mozhyetye li vy ukazat nomyer moyey strakhovki v otchyetye?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "请给我一张票。",
      "text": "Один билет, пожалуйста.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Odin bilyet, pozhaluysta.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "我们要两间房。",
      "text": "Нам нужны две комнаты.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Nam nuzhny dvye komnaty.",
    ...
    },
    {
      ...
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Kakoy syegodnya dyen nyedyeli?",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "我昨天到的。",
      "text": "Я приехал вчера.",
      "direction": "traveler-hears",
      "intent": "confirm",
      "pronunciation": "Ya priyekhal vchyera.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "我想要靠窗的座位。",
      "text": "Я хочу место у окна.",
      "direction": "traveler-says",
      "intent": "confirm",
      "pronunciation": "Ya khochu myesto u okna.",
    ...
    },
    {
      ...
      "direction": "traveler-says",
      "intent": "repair",
      "pronunciation": "Mnye nuzhyen vrach.",
    ...
    },
    {
      ...
      "kind": "phrase",
      "zh": "附近有药店吗？",
      "text": "Есть ли поблизости аптека?",
      "direction": "traveler-says",
      "intent": "ask",
      "pronunciation": "Yest li poblizosti aptyeka?",
